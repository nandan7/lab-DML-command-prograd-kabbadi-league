...
--6. Insert into team
INSERT INTO TEAM(ID,NAME,COACH,HOME_CITY,CAPTAIN)VALUES(1,'RAVI','MAHESH',5,1);
INSERT INTO TEAM(ID,NAME,COACH,HOME_CITY,CAPTAIN)VALUES(2,'TEJA','MAHESH',5,5);
--7. Insert into player
INSERT INTO PLAYER(ID,NAME,COUNTRY,SKILL_ID,TEAM_ID)VALUES(1,'NARESH','INDIA',1,1);
INSERT INTO PLAYER(ID,NAME,COUNTRY,SKILL_ID,TEAM_ID)VALUES(2,'SUMAN','INDIA',2,2);
INSERT INTO PLAYER(ID,NAME,COUNTRY,SKILL_ID,TEAM_ID)VALUES(3,'KHAN','BANGLADESH',2,1);
--8. Insert into venue
INSERT INTO VENUE(ID,STADIUM_NAME,CITY_ID)VALUES(1,'HYDERABAD',1);
--9. Insert into event
INSERT INTO EVENT(ID,INNINGS_ID,EVENT_NO,RAIDER_ID,RAIDER_POINT,DEFENDING_POINTS,CLOCK_IN_SECONDS,TEAM_ONE_SCORE,TEAM_TWO_SCORE)VALUES(1,2,3,4,5,6,7,8,9);
